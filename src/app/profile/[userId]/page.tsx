...
export default function ProfilePage() {
  ...
  const userId = (params?.userId as string) || currentUser?._id;
  ...
  const loadProfile = async (id: string) => {
    try {
      ...
      if (currentUser) {
        ...
        setIsFollowing(currentUserId ? data.followers.includes(currentUserId) : false);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-500">
      ...
      <div className="flex">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <Badge variant={user.accountType === 'business' ? 'primary' : 'secondary'}>
        ...
        {/* Posts */}
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Posts</h2>
