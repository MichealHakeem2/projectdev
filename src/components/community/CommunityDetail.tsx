    ...
    const loadData = async () => {
      try {
        const [commData, postsData] = await Promise.all([
          ...
          // We don't have getCommunityPosts in mock yet, but we can filter from all posts
          postService.getFeed() 
        ]);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="px-8 pb-6">
          <div className="relative flex flex-col md:flex-row justify-between items-start md:items-end -mt-12 mb-6 gap-4">
            <div className="flex flex-col md:flex-row items-start md:items-end gap-6">
              ...
              <div className="mb-2">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {community.isPrivate ? <Lock className="w-5 h-5 text-gray-400" /> : <Globe className="w-5 h-5 text-gray-400" />}
                </div>
                <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-gray-900 dark:text-gray-100">{community.memberCount}</span> members
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 w-full md:w-auto">
              ...
              {isModerator && (
                <Button variant="ghost" className="p-2 rounded-xl border border-gray-200 dark:border-gray-800 h-11">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {activeTab === 'about' && (
              ...
              >
                <Card className="p-8 space-y-6">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">About this community</h3>
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-4 border-t border-gray-100 dark:border-gray-800">
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-gray-100">{new Date(community.createdAt).toLocaleDateString()}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Privacy</p>
                      <p className="text-gray-900 dark:text-gray-100">{community.isPrivate ? 'Private' : 'Public'}</p>
                    </div>
                  </div>

                  <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Moderators</h3>
                    <div className="flex flex-wrap gap-4">
                      ...
                      <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-800/50 p-2 rounded-xl pr-4">
                        <Avatar src={community.createdBy.avatar} alt={community.createdBy.username} size="sm" />
                        <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{community.createdBy.username}</span>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-4">Rules</h3>
          ...
          <Card className="p-6 bg-gradient-to-br from-primary-600 to-indigo-700 text-white border-none">
            ...
            <p className="text-blue-100 text-sm mb-4">
              Invite your colleagues to join {community.name} and share knowledge together.
            </p>
